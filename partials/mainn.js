...
if (event.code === "Enter" && inputField.id == "input" && inputField.value && inputtt == "false") {
inputField.value = "";
     output(input);
 stateHandle();
...
bttn.innerHTML = `<input id="bttnn" type="submit" onclick="location.href='/support';" value="Support" />`; //<button id="bttnn" type="button" onclick="window.location.href='/support'">Submit Itt</button>`;
