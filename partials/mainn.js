...
bttn.innerHTML = `<input type="button" onclick="location.href='/support'" value="Suport" />`; //<button id="bttnn" type="button" onclick="window.location.href='/support'">Submit Itt</button>`;
